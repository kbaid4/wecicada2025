...
// Dummy data for Limousine Services
const servicesData = [
  { 
    name: 'Elite Limousine Co.', 
    location: 'Downtown', 
    rating: 4.9, 
    image: '/images/venues/15.png'
  },
  { 
    name: 'Premier Limo Services', 
  ...
  { 
    name: 'Black Tie Limousines', 
    location: 'East District', 
    rating: 4.8, 
    image: '/images/venues/15.png'
  },
  { 
    name: 'First Class Limo', 
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search limousine services..."
          value={search}
