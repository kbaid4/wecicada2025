...
// Dummy data for Linen Rental Services
const servicesData = [
  { 
    name: 'Elegant Linens Co.', 
    location: 'Downtown', 
    rating: 4.8, 
    image: '/images/venues/2.png'
  },
  { 
    name: 'Premier Table Linens', 
    location: 'Business District', 
    rating: 4.9, 
    image: '/images/venues/2.png'
  },
  { 
    name: 'Luxury Linen Rentals', 
    location: 'Uptown', 
    rating: 4.7, 
    image: '/images/venues/2.png'
  },
  { 
    name: 'Classic Tableware & Linens', 
    location: 'West End', 
    rating: 4.6, 
    image: '/images/venues/2.png'
  },
  { 
    name: 'Elite Linen Services', 
    location: 'East District', 
    rating: 4.8, 
    image: '/images/venues/2.png'
  },
  { 
    name: 'Grand Event Linens', 
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search linen rental services..."
          value={search}
...
export default LinenRentalServicesPage;
