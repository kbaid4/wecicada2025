...
// Dummy data for Technical Support Services
const techSupportData = [
  { 
    name: 'TechSupport Pros', 
    location: 'Downtown', 
    rating: 4.8, 
    image: '/images/venues/5.png',
  },
  { 
    name: 'Event Tech Solutions', 
    location: 'City Center', 
    rating: 4.9, 
    image: '/images/venues/5.png',
  },
  { 
    name: 'Rapid Response Tech', 
...
const TechnicalSupportServicesPage = () => {
  ...
  let filteredServices = techSupportData.filter(service =>
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search technical support services..."
          value={search}
      ...
      <div className={styles['hotels-grid']}>
        {filteredServices.length === 0 ? (
          <div style={{ color: '#441752', fontWeight: 500, fontSize: 18, marginTop: 40 }}>
            No technical support services found.
          </div>
        ) : (
