...
// Dummy data for Bartending Services
const bartendingServicesData = [
  { 
    name: 'Mix Masters', 
    location: 'Downtown', 
    rating: 4.8, 
...
const BartendingServicesPage = () => {
  const [search, setSearch] = useState('');
  const [sort, setSort] = useState('name');
  const navigate = useNavigate();

  // Filtering and sorting logic
  let filteredServices = bartendingServicesData.filter(service =>
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search bartending services..."
          value={search}
...
export default BartendingServicesPage;
