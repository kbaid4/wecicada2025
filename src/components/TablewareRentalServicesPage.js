...
const servicesData = [
  { 
    name: 'Elegant Tableware Rentals', 
    location: 'Downtown', 
    rating: 4.8, 
    image: '/images/venues/3.png'
  },
  { 
    name: 'Grand China & Crystal', 
  ...
  { 
    name: 'Classic Dinnerware Co.', 
    location: 'West End', 
    rating: 4.6, 
    image: '/images/venues/3.png'
  },
  { 
    name: 'Elite Tabletop Rentals', 
    location: 'East District', 
    rating: 4.8, 
    image: '/images/venues/3.png'
  },
  { 
    name: 'Premier Tableware Solutions', 
...
const TablewareRentalServicesPage = () => {
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search tableware rental services..."
          value={search}
...
export default TablewareRentalServicesPage;
