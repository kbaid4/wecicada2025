...
// Dummy data for Shuttle Services
const servicesData = [
  { 
  ...
  { 
    name: 'Urban Transit Shuttles', 
    location: 'Uptown', 
    rating: 4.7, 
    image: '/images/venues/14.png'
  },
  { 
    name: 'Premier Shuttle Co.', 
    location: 'West End', 
    rating: 4.6, 
    image: '/images/venues/14.png'
  },
  { 
    name: 'Rapid Transport Solutions', 
    location: 'East District', 
    rating: 4.8, 
    image: '/images/venues/14.png'
  },
  { 
    name: 'Eco Shuttle Services', 
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search shuttle services..."
          value={search}
