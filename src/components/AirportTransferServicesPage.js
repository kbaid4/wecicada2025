...
// Dummy data for Airport Transfer Services
const servicesData = [
  { 
    name: 'SkyLink Transfers', 
    location: 'Downtown', 
    rating: 4.8, 
  ...
  { 
    name: 'Premier Airport Transfers', 
    location: 'Uptown', 
    rating: 4.9, 
    image: '/images/venues/19.png'
  },
  { 
    name: 'City Airport Shuttles', 
    location: 'West End', 
    rating: 4.6, 
    image: '/images/venues/19.png'
  },
  { 
    name: 'Elite Airport Transfers', 
...
const AirportTransferServicesPage = () => {
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search airport transfer services..."
          value={search}
      ...
      <div className={styles['hotels-grid']}>
        {filteredServices.length === 0 ? (
          <div style={{ color: '#441752', fontWeight: 500, fontSize: 18, marginTop: 40 }}>
            No airport transfer services found.
          </div>
        ) : (
...
export default AirportTransferServicesPage;
