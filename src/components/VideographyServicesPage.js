...
// Dummy data for Videography Services
const servicesData = [
  { 
    name: 'Elite Video Productions', 
    location: 'Downtown', 
    rating: 4.8, 
    image: '/images/venues/9.png'
  },
  { 
    name: 'Premier Event Films', 
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search videography services..."
          value={search}
...
export default VideographyServicesPage;
