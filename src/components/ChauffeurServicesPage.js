...
// Dummy data for Chauffeur Services
const servicesData = [
  { 
  ...
  { 
    name: 'First Class Drive', 
    location: 'West End', 
    rating: 4.7, 
    image: '/images/venues/18.png'
  },
  { 
    name: 'Luxury Ride Chauffeurs', 
    location: 'East District', 
    rating: 4.8, 
    image: '/images/venues/18.png'
  },
  { 
    name: 'Professional Chauffeur Co.', 
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search chauffeur services..."
          value={search}
