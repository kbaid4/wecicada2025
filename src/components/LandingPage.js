...
<p style={{ color: '#441752', fontSize: '12px', marginTop: '4px' }}>
  <a href="#" onClick={() => navigate('/TermsAndConditions')} style={{ color: '#441752', textDecoration: 'underline' }}>Terms & Conditions</a>
</p>
      </footer>
    </div>
  );
