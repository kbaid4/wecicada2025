...
// Dummy data for Bus/Coach Rentals
const servicesData = [
  { 
    name: 'City Bus Rentals', 
    location: 'Downtown', 
    rating: 4.7, 
    image: '/images/venues/16.png'
  },
  { 
    name: 'Elite Coach Services', 
    location: 'Business District', 
    rating: 4.8, 
    image: '/images/venues/16.png'
  },
  { 
    name: 'Premier Bus Charter', 
    location: 'Uptown', 
    rating: 4.6, 
    image: '/images/venues/16.png'
  },
  { 
    name: 'Luxury Coach Rentals', 
    location: 'West End', 
    rating: 4.7, 
    image: '/images/venues/16.png'
  },
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search bus/coach rentals..."
          value={search}
...
export default BusCoachRentalsPage;
