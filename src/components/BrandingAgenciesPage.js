...
const brandingAgenciesData = [
  { 
    name: 'BrandCraft Solutions', 
    location: 'Downtown', 
    rating: 4.7, 
...
const BrandingAgenciesPage = () => {
  ...
  let filtered = brandingAgenciesData.filter(agency =>
