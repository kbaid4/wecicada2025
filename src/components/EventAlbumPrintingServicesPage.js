...
// Dummy data for Event Album Printing Services
const servicesData = [
  { 
    name: 'Precious Moments Albums', 
    location: 'Downtown', 
    rating: 4.8, 
    image: '/images/venues/12.png'
  },
  { 
    name: 'Elegant Album Designs', 
    location: 'Business District', 
    rating: 4.9, 
    image: '/images/venues/12.png'
  },
  { 
    name: 'Timeless Memories Press', 
    location: 'Uptown', 
    rating: 4.7, 
    image: '/images/venues/12.png'
  },
  { 
    name: 'Chapters Album Studio', 
    location: 'West End', 
    rating: 4.6, 
    image: '/images/venues/12.png'
  },
  { 
    name: 'Heirloom Album Co.', 
    location: 'East District', 
    rating: 4.8, 
    image: '/images/venues/12.png'
  },
  { 
    name: 'Storybook Albums', 
...
const EventAlbumPrintingServicesPage = () => {
    ...
    <div className={styles['app-container']}>
      ...
      <div className={styles['hotels-toolbar']}>
        <input
          ...
          type="text"
          placeholder="Search album printing services..."
          value={search}
      ...
      <div className={styles['hotels-grid']}>
        {filteredServices.length === 0 ? (
          <div style={{ color: '#441752', fontWeight: 500, fontSize: 18, marginTop: 40 }}>
            No album printing services found.
          </div>
        ) : (
...
export default EventAlbumPrintingServicesPage;
